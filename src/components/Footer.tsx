  ...
  return (
    <footer className="py-6 mt-auto transition-colors duration-300" style={{
      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-secondary/60">
          <div className="text-center md:text-left">
            <p className="font-medium text-secondary/80 mb-1">
              DiMZzz Pnc °o♡o°
            </p>
            <p>
              © {currentYear} Dimas Ponco Prabowo. All rights reserved.
            </p>
          </div>
